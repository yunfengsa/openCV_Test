...
//        if(intent.ACTION_VIEW.equals(action))
        ...
        Log.d(TAG,videoFile.getAbsolutePath()+videoFile.getTotalSpace());
        ...
        switch (ImageManipulationsActivity.viewMode) {
            ...
            case ImageManipulationsActivity.VIEW_MODE_ZOOM:
                ...
                if(Core.countNonZero(top) > mheight*mwidth/4 && Core.countNonZero(bottom) < mheight*mwidth/9  ){
                    if(App[0]!=0)
                        Imgproc.rectangle(zoomCorner, new Point(0, 0), new Point(msize.width, msize.height/2 ), new Scalar(255, 0, 0, 255), 2);
                    App[0]++;
                }

                if(Core.countNonZero(bottom) > mheight*mwidth/4 ){
                    if(App[1]!=0)
                        Imgproc.rectangle(zoomCorner, new Point(0, msize.height/2), new Point(msize.width, msize.height), new Scalar(255,225, 0, 255), 2);
                    App[1]++;
                }
